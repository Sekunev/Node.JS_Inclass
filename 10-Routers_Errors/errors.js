...
app.get("/user/:id", (req, res, next) => {
  try {
    ...
    console.log("err-->", err.message, err.cause);
...
// express-async-handler Express.js tabanlı uygulamalarda kullanılan bir middleware (ara yazılım) modülüdür ve özellikle asenkron işlevlerin kullanıldığı yönlendirme işlevlerinde hata yönetimini kolaylaştırmak için tasarlanmıştır. Bu middleware, asenkron işlevlerin içinde oluşan hataları otomatik olarak yakalar ve hata işleme işlevlerine ileterek kodun daha temiz ve hata toleranslı olmasını sağlar.
