...
// console.log(Car.getDetails().colors[0]);
...
const newArr = ["new-value", "new-value2", ...testArray];
console.log(newArr);
...
// console.log(otherItems.startEngine());

//?  isim değişikliğimümkün.
const {
  year: modelYear,
  model: newName,
  brand,
} = Car; /* Orjinal İsim değişmiyor.  */
...
//! Object to Array:
// const arr = [...Car]; /* Tür hatası iterable değil*/
// const arr = [...Car.colors];
// const arr = Object.entries(Car);  /* objeyi array'a çevirme*/
// console.log(arr);
...
console.log(
  newCar2.startEngine()
); /* startEngine fonksiyonu çalışmaya müteakip içindeki isRunning'e ulaştık.*/
console.log(newCar2.isRunning);
