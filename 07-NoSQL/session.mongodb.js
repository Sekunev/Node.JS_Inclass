//!Önce  MongoDB CommunityServer & Compass ve MongoDB Shell (Mongosh) yüklemesini readme'deki yönergelere göre yap.

// Mongo Strructure
Database-- > Collection-- > Document-- > Field;
// Mongo Strructure
// SQL'de nasıldı
Database-- > Tables-- > Colomns-- > Rows;

// Adım Adım Yapılacaklar;
// 1- https://www.mongodb.com/ 'dan hesap oluştur. 
// 2- Organiation oluştur.
// 3- Atlas seçeneğini seç isim ver. next'de
// 4- IP' pasif yap create organisation de.
// 5- Organiation içerisinde Project oluştur. İsim ver. Ayarları değiştirme.
// 6- Sonra Database sekmesinde Database oluştur. Free-- AWS-- seç ve create de.
// 7- Artırk uzakta bir Database'imiz var. Kullanıcı adı ve passwor belirle.
// 8- Local env..'yi seç. IP'ile ilgili bişey yapma. Finish'de.

// 9- MongoDB'yi 2 şekilde arayüz ile yönetebiliyoruz. Bir tanesi WSCode Extention'u readme'de var. Dİgeri'de Compass
// 10- Compass altındaki terminal'den de Mongosh kullanılabilir.
// 11- Compass 'dan yerel (mongodb://localhost:27017/) ve uzak DB' (mongodb+srv://ahlatlipost:*****@abdullahdatabase.3zaubd9.mongodb.net/?retryWrites=true&w=majority) lere bağlanabilirim. 
// 12- Aynı bağlanma işlemlerini MongoDb extention'da da yap.
// 13- Uzak DB'in connection stringi'ni (mongodb+srv://ahlatlipost:*****@abdullahdatabase.3zaubd9.mongodb.net/?retryWrites=true&w=majority) connect/Driver ile alabiliriz.
// 14- Database'i silmek için ... --> Terminate'ye tıkla.
...
/* General */
// Terminalde Mongosh'ı çalıştırma
mongosh // Bu Local'deki  Sunucuya bağlar.
mongosh 'mongodb+srv://ahlatlipost:28911982@abdullahdatabase.3zaubd9.mongodb.net/?retryWrites=true&w=majority' // Bu Uzak'daki  Sunucuya bağlar.

// help
show dbs // Bağlı olunan server'daki DB listesi.
show("dbs") // Bağlı olunan server'daki DB listesi.
