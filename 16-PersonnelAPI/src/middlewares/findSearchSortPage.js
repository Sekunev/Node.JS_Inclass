...
module.exports = (req, res, next) => {
  ...
  // filters = {} parametresinin amacı seçilen departmandaki personellerin filtrelenmesi maksadıyla department.controller'da oluşturulan personnels controller'ı için.
