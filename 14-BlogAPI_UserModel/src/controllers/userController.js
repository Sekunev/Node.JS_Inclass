...
module.exports.User = {
  ...
  login: async (req, res) => {
    ...
    if (email && password) {
      ...
      if (user) {
        // ömür varsa cookie ömür yoksa session. sesion her halukarda var. Eğer beni hatırla inputu varsa  maxAge ile süre tanımı yapıyoruz.  ve cookie oluyor. Bu bölümü postman'da cookie sekmesinden görüyoruz.
